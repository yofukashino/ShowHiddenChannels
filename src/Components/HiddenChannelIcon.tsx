...
export default React.memo((props: React.HTMLAttributes<SVGElement>): React.ReactElement | null => {
  ...
  if (SettingValues.get("hiddenChannelIcon", defaultSettings.hiddenChannelIcon) === "eye")
    return (
      <svg {...props} viewBox="0 0 24 24">
        <path
          fill="currentColor"
  ...
  if (SettingValues.get("hiddenChannelIcon", defaultSettings.hiddenChannelIcon) === "custom")
    return <NetworkSVG {...props} />;
  return null;
});
